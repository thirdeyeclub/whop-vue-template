...
export declare namespace NotificationCreateParams {
    interface SendNotificationV2InputWithCompanyID {
        /**
    ...
    interface SendNotificationV2InputWithExperienceID {
        /**
         * The content of the notification
         */
        content: string;
...
export declare namespace Notifications {
    export { type NotificationCreateResponse as NotificationCreateResponse, type NotificationCreateParams as NotificationCreateParams, };
}
