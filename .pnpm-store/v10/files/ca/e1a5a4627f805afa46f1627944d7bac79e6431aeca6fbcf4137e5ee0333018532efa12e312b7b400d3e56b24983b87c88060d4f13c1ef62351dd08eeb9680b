...
export declare class Shipments extends APIResource {
    /**
...
export declare namespace ShipmentListResponse {
    /**
     * The payment of the shipment
     */
    interface Payment {
...
export declare namespace Shipments {
    export { type ShipmentListResponse as ShipmentListResponse, type ShipmentListResponsesCursorPage as ShipmentListResponsesCursorPage, type ShipmentCreateParams as ShipmentCreateParams, type ShipmentListParams as ShipmentListParams, };
}
