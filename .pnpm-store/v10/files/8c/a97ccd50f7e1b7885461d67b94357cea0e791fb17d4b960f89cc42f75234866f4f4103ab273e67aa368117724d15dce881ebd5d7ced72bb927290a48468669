...
export declare class AccountLinks extends APIResource {
    /**
...
export declare namespace AccountLinks {
    export { type AccountLinkCreateResponse as AccountLinkCreateResponse, type AccountLinkCreateParams as AccountLinkCreateParams, };
}
//# sourceMappingURL=account-links.d.mts.map